function load_tab5() {
    $.ajax({
        url: '/Home/Data_TotalTargetProgress',
        type: 'GET',
        ...
        error: function () { alert("خطا در دریافت داده!"); }
    });

    $.ajax({
        url: '/Home/Data_DelegateProgress',
        type: 'GET',
        async: true,
        dataType: "json",
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت پیشرفت نمایندگان:", textStatus, errorThrown);
        }
    });
    ...
    function delegateHeatmapChart(data) {
        ...
        Highcharts.chart('heatmapChart', {
            ...
            title: { text: 'نقشه حرارتی پیشرفت گروه‌ها به تارگت ۱۴۰۴' },
    ...
    function delegateProgressChart(data) {
        Highcharts.chart('chartDelegateProgress', {
            chart: { type: 'bar', backgroundColor: '#f8f9fa', height: 1000 },
            title: { text: 'پیشرفت نمایندگان به تارگت ۱۴۰۴', style: { fontWeight: 'bold' } },
            xAxis: {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت داده‌های نمایندگان فعال:", textStatus, errorThrown);
        }
    });
            ...
            plotOptions: {
                column: {
                    ...
                    point: {
                        events: {
                            click: function () {
                                window.location = '/Home/Index/' + this.name;
                            }
                        }
                    }
                }
    ...
    $.ajax({
        url: '/Home/Data_ActiveDelegacyByMiniatori',
        type: 'GET',
        async: true,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
    ...
    $.ajax({
        url: '/Home/Data_ActiveDelegacy_RCBO',
        type: 'GET',
        async: true,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
    ...
    $.ajax({
        url: '/Home/Data_DemandTrend_Miniature',
        type: 'GET',
        async: true,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت داده‌های روند تقاضا:", textStatus, errorThrown);
        }
    });
    ...
    function visitorDataTrend(a) {
        Highcharts.chart('chartTrend', {
            chart: { type: 'column' },
            title: { text: 'روند تقاضای کلید مینیاتوری در ماه' },
            xAxis: {
                type: 'category',
                labels: { rotation: -45, style: { fontSize: '13px' } }
            },
    ...
    $.ajax({
        url: '/Home/Data_DemandTrend_RCBO',
        type: 'GET',
        async: true,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
    ...
    function visitorDataTrendRCBO(a) {
        Highcharts.chart('chartTrend-RCBO', {
            chart: { type: 'column' },
            title: { text: 'روند تقاضای کلید محافظ جان در ماه' },
            xAxis: {
                type: 'category',
                labels: { rotation: -45, style: { fontSize: '13px' } }
            },
    ...
    $.ajax({
        url: '/Home/Data_RepPerformanceByCategory',
        type: 'GET',
        async: true,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت داده‌های عملکرد نمایندگان:", textStatus, errorThrown);
        }
    });

    function repPerformanceChart(data) {
        Highcharts.chart('chartRepPerformance', {
            chart: { type: 'column' },
            title: { text: 'عملکرد نمایندگان بر اساس دسته محصولات (کلید مینیاتوری: میله،کلید محافظ جان: خط)' },
            xAxis: {
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت داده‌های پروفایل رادار نمایندگان:", textStatus, errorThrown);
        }
    });

    function repRadarChart(data) {
        Highcharts.chart('chartRepRadar', {
            chart: { polar: true, type: 'area' },
            title: { text: '10 نماینده برتر براساس امتیاز' },
            xAxis: {
                categories: data.categories,
    ...
    $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت داده‌های محصولات محبوب:", textStatus, errorThrown);
        }
    });
    ...
    $.ajax({
        ...
        success: function (response) {
            Highcharts.chart('chart4', {
                ...
                title: { text: 'تعداد سفارشات هر محصول' },
                xAxis: {
                    type: 'category',
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            console.error("خطا در دریافت داده‌های سفارشات محصولات:", textStatus, errorThrown);
        }
    });
}